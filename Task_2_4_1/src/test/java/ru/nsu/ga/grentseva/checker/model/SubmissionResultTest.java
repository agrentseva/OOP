...
class SubmissionResultTest {
    ...
    void javadocSetterWorks() {
        ...
        assertTrue(result.isJavadocGenerated());
    }
    ...
    void stylePassedSetterWorks() {
        ...
        assertTrue(result.isStylePassed());
    }
    ...
    void styleErrorsSetterWorks() {
        ...
        assertEquals(5, result.getStyleErrors());
    }
    ...
    void testsPassedSetterWorks() {
        ...
        assertEquals(10, result.getTestsPassed());
    }
    ...
    void finalScoreSetterWorks() {
        ...
        assertEquals(9.5, result.getFinalScore());
    }

    @Test
    void errorMessageSetterWorks() {
        SubmissionResult result = new SubmissionResult();
        result.setErrorMessage("Compilation error");

        assertEquals("Compilation error", result.getErrorMessage());
    }
}