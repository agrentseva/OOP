...
public class ConfigDslParser {
    ...
    public static void loadFile(Path path, CourseConfig config) throws IOException {
        ...
        configuration.setScriptBaseClass(ConfigScript.class.getName());
        configuration.setSourceEncoding("UTF-8");

        GroovyShell shell =
                new GroovyShell(ConfigDslParser.class.getClassLoader(), new Binding(), configuration);
