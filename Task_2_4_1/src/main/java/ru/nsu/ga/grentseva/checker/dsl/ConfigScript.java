...
public abstract class ConfigScript extends Script {
    ...
    public void submission(String studentId,
                           String taskId,
                           Closure<?> closure) {
        ...
        SubmissionBuilder builder =
                new SubmissionBuilder(submission);
    ...
    public void settings(Closure<?> closure) {
        ...
        SettingsBuilder builder =
                new SettingsBuilder(config.getSettings());
    ...
    public static class TaskBuilder
        ...
        public void setProperty(String name,
            ...
            switch (name) {
                ...
                case "softDeadline" ->
                        task.setSoftDeadline(
                                parseDate(value.toString())
                        );

                case "hardDeadline" ->
                        task.setHardDeadline(
                                parseDate(value.toString())
                        );
    ...
    public static class GroupBuilder
        ...
        public void student(String githubId,
                            Closure<?> closure) {
        ...
        public void setProperty(String name,
            ...
            switch (name) {
                ...
                case "softDeadlinePenalty" ->
                        settings.setSoftDeadlinePenalty(
                                Double.parseDouble(value.toString())
                        );

                case "maxBonus" ->
                        settings.setMaxBonus(
                                Double.parseDouble(value.toString())
                        );

                case "testTimeoutSeconds" ->
                        settings.setTestTimeoutSeconds(
